      ...
      <div className="page-content">
        <div>
          ...
          <p>
            ...
            interactive map view of the same ride data. It pings the Shift2Bikes calendar API and displays bike fun
            events on an interactive map. Rides are initially sorted according to distance from user, if the user allows
            location sharing. Otherwise the events are sorted according to distance from Thai Champa, my favorite Thai
            food cart.
          </p>
        </div>
        <div>
